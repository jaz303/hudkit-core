...
},{"./lib/Context":2,"./lib/Instance":3,"./lib/RootPane":4,"./lib/Widget":5,"./lib/constants":6,"./lib/registry":7,"./lib/signals":8,"./lib/theme":9,"fs":17}],2:[function(require,module,exports){
...
},{"./constants":6,"./registry":7,"./signals":8}],3:[function(require,module,exports){
var fs 			= require('fs'),
...
function Instance(window) {
    ...
    var root = this.document.body;
    root.className = 'hk';
    root.appendChild(this.rootPane.getRoot());
...
},{"./constants":6,"./registry":7,"./signals":8,"./theme":9,"fs":17,"hudkit-action":12,"style-tag":15}],4:[function(require,module,exports){
var fs      = require('fs'),
    trbl    = require('trbl');
...
},{"fs":17,"trbl":16}],5:[function(require,module,exports){
var fs 		= require('fs'),
...
},{"classkit":10,"domutil":11,"fs":17}],6:[function(require,module,exports){
module.exports = {};
...
},{"./signals":8}],8:[function(require,module,exports){
...
s('moduleRegistered');
s('widgetRegistered');
},{"signalkit":14}],9:[function(require,module,exports){
...
},{"signalkit":13}],13:[function(require,module,exports){
(function (process){//
// Helpers
...
},{"/usr/local/lib/node_modules/watchify/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":18}],14:[function(require,module,exports){
module.exports=require(13)
},{"/usr/local/lib/node_modules/watchify/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":18}],15:[function(require,module,exports){
// adapted from
